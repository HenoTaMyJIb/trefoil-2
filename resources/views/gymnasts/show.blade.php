<modal v-if="showEditModal" @close="showEditModal = false" ref="modal">
<span slot="title">Võimleja #<span v-text="activeRow.id"></span></span>
        <p class="title is-5">Võimleja andmed</p>
        <table class="table is-bordered is-striped is-narrow">
            <tr>
                <td style="width:200px;"><b>Rühm:</b></td>
                <td v-text="activeRow.group.name"></td>
            </tr>
            <tr>
                <td><b>Nimi:</b></td>
